...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/parrot/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_parrot/audio_effects.conf \
...
PRODUCT_COPY_FILES += \
    vendor/hardware/xiaomi/vibrator/excluded-input-devices.xml:$(TARGET_COPY_OUT_VENDOR)/etc/excluded-input-devices.xml
